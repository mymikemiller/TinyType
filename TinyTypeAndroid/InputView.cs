...
namespace TinyTypeAndroid
{
    ...
    public class InputView : View, View.IOnTouchListener
    {
        ...
        private void DrawQuadrantOutline(Canvas canvas, int quadrant)
        {
            Position position = (Position)quadrant;
            Color color = GetPositionColor(position);

            int gradientSize = mViewInfo.Position == position ? mViewInfo.LargeGradientSize : mViewInfo.SmallGradientSize;
            // angleOfFirstLine is in radians
            double angleOfFirstLine = (quadrant - 1) * Math.PI / 2.0;
            // Use a line to figure out where to start the pole
            Line findPoleStart = new Line(mViewInfo.MiddleSquare.Center, angleOfFirstLine, mViewInfo.MiddleSquare.Width / 2.0);
            Line pole = new Line(findPoleStart.End, angleOfFirstLine, mViewInfo.PoleLength);

            Drawing.ClearClip(canvas, mViewInfo);
            Drawing.DrawGradientLine(canvas, pole, gradientSize, color, mViewInfo.GetPositionRect((Position)quadrant));

            // Find the angle of the second line
            double angleOfSecondLine = angleOfFirstLine + Math.PI / 2.0;
            findPoleStart = new Line(mViewInfo.MiddleSquare.Center, angleOfSecondLine, mViewInfo.MiddleSquare.Width / 2.0);
            Line pole2 = new Line(findPoleStart.End, angleOfSecondLine, mViewInfo.PoleLength);

            Drawing.ClearClip(canvas, mViewInfo);
            Drawing.DrawGradientLine(canvas, pole2, -gradientSize, color, mViewInfo.GetPositionRect((Position)quadrant));
            
            // Draw the arc between the lines
            int arcAngle = 360 - 90 * quadrant;
            Drawing.ClearClip(canvas, mViewInfo);
            Drawing.DrawGradientArc(canvas, mViewInfo.MiddleSquare.Center, mViewInfo.MiddleSquare.Width / 2f, arcAngle, 90, gradientSize, GetPositionColor(position));
            Drawing.ClearClip(canvas, mViewInfo);
        }
        ...
        private void DrawOutline(Canvas canvas)
        {
            ...
            {
                DrawQuadrantOutline(canvas, quadrant);
            }
            /*
            ...
            gradientSize = mViewInfo.Position == Position.Q2 ? largeGradientSize : smallGradientSize;
            //start = new TinyTypeLib.PointF(mViewInfo.MiddleSquare.Right, mViewInfo.MiddleSquare.Center.Y);
            //end = new TinyTypeLib.PointF(start.X + mViewInfo.PoleLength, start.Y);
            //Drawing.DrawGradientLine(canvas, mViewInfo.Q2Border, gradientSize, GetPositionColor(Position.Q2));
            Drawing.ClearClip(canvas, mViewInfo);
            Drawing.DrawGradientArc(canvas, mViewInfo.MiddleSquare.Center, mViewInfo.MiddleSquare.Width / 2f, 180, 90, gradientSize, GetPositionColor(Position.Q2));
            Drawing.ClearClip(canvas, mViewInfo);
            ...
            gradientSize = mViewInfo.Position == Position.Q3 ? largeGradientSize : smallGradientSize;
            //Drawing.DrawGradientPath(canvas, mViewInfo.Q3Border, gradientSize, GetPositionColor(Position.Q3));
            Drawing.ClearClip(canvas, mViewInfo);
            Drawing.DrawGradientArc(canvas, mViewInfo.MiddleSquare.Center, mViewInfo.MiddleSquare.Width / 2f, 90, 90, gradientSize, GetPositionColor(Position.Q3));
            Drawing.ClearClip(canvas, mViewInfo);
            ...
            gradientSize = mViewInfo.Position == Position.Q4 ? largeGradientSize : smallGradientSize;
            //Drawing.DrawGradientPath(canvas, mViewInfo.Q4Border, gradientSize, GetPositionColor(Position.Q4));
            Drawing.ClearClip(canvas, mViewInfo);
            Drawing.DrawGradientArc(canvas, mViewInfo.MiddleSquare.Center, mViewInfo.MiddleSquare.Width / 2f, 0, 90, gradientSize, GetPositionColor(Position.Q4));
            Drawing.ClearClip(canvas, mViewInfo);
        ...
        private void DrawMiddleSquare(Canvas canvas)
        {
            ...
            */
            ...
            Drawing.DrawGradientArc(canvas, mViewInfo.MiddleSquare.Center, mViewInfo.MiddleSquare.Width / 2f, 0, -360, mViewInfo.Position == Position.Middle ? mViewInfo.LargeGradientSize : mViewInfo.SmallGradientSize, GetPositionColor(Position.Middle));
        ...
        public bool OnTouch(View v, MotionEvent e)
        {
            ...
            switch(e.Action)
            {
                ...
                case MotionEventActions.Move:
                    ...
                    {
                        // Add the middle position so we know we actually finished the path
                        mViewInfo.AddToPath(pos);
